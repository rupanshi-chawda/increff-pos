                ...
                <fo:static-content flow-name="xsl-region-before">
                    <fo:block>
                        <fo:table>
                            ...
                            <fo:table-column column-width="8.5cm"/>
                            <fo:table-body>
                                <fo:table-row font-size="30pt" line-height="30px" color="#293459">
                                    ...
                                    <fo:table-cell>
                                        <fo:block text-align="right" padding-top="5pt">
                                            INVOICE
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row>
                                    <fo:table-cell font-size="8pt" padding-left="5pt" padding-top="5pt">
                                        <fo:block>
                                            Sector 6, HSR Layout&#x2028;
            ...
            <fo:table line-height="30px">
                ...
                <fo:table-body>
                    ...
                    <fo:table-row font-weight="bold">
                        ...
                        <fo:table-cell  text-align="right" padding-right="3pt" background-color="#293459" border="1px solid #b8b6b6" color="white">
                            <fo:block>
